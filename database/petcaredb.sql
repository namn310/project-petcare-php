...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 16, 2024 lúc 06:26 AM
...
(3, 'Hồ Thị Thanh Ngân', '1717923845_woman-6054868_1280 (1).webp', '155-157 Trần Quốc Thảo, Quận 3, Hồ Chí Minh', '1994-01-09', 'Nữ', '0913456767', 'Bán hàng', 'nganhtt@gmail.com', 2147483647, '09-06-24'),
(4, 'Trần Khả Ái', '1717923974_512x512bb.jpg', '	6 Nguyễn Lương Bằng, Tân Phú, Quận 7, Hồ Chí Minh', '1998-06-09', 'Nữ', '0912345678', 'Bác sĩ thú y', 'aitk@gmail.com', 2147483647, '09-06-24'),
(5, 'Trần Anh Khoa', '1717924044_malecostume-512.webp', 'Thanh Xuân, Hà Nội', '1989-07-06', 'Nam', '0913456767', 'Spa-Grooming', 'khoa@gmail.com', 2147483647, '09-06-24');
...
(38, 1, '2024-06-15 20:34:21', 0),
(39, 1, '2024-06-15 23:07:27', 0);
...
(97, 8, 'Pate Mèo Trưởng Thành Royal Canin Instinctive 85g', 78, '30000', '30000', '', 'Pate', 'Còn hàng', '1718509803_sg-11134201-22100-9ezpbc24h2ivca-1680750093020.webp', '<p><strong>&nbsp;Pate Mèo Trưởng Thành Royal Canin Instinctive</strong></p><ul><li>Thương hiệu: Royal Canin</li><li>Phù hợp cho: Mèo trưởng thành (trên 12 tháng tuổi)</li><li>Pate cho mèo trưởng thành Royal Canin Instinctive là sản phẩm được thiết kế dành riêng cho mèo trên 12 tháng tuổi. Pate Royal Canin Instinctive chứa các thành phần trích xuất thịt, sữa và các khoáng chất thiết yếu nhằm hỗ trợ tăng cường hệ thống miễn dịch cho mèo, thúc đẩy chúng tăng trưởng. Thức ăn cho mèo ROYAL CANIN được tạo ra với sự cân bằng tối ưu giữa các protein, chất béo và carbohydrate để hỗ trợ sự ngon miệng, bổ sung dinh dưỡng hoàn hảo.</li></ul><p><strong>Lợi ích:</strong></p><ul><li>Tạo ra nguồn dinh dưỡng phù hợp tối ưu theo bản năng ưa thích của mèo trưởng thành, giúp mèo ăn ngon miệng hơn.</li><li>Hỗ trợ tăng cường hệ thống bài tiết khỏe mạnh.</li><li>Giữ cân nặng lí tưởng cho mèo.&nbsp;</li></ul><p><strong>Thành phần dinh dưỡng</strong></p><ul><li>Thành phần:&nbsp;Thịt và dẫn xuất từ thịt, cá và dẫn xuất từ cá, protein thực vật, ngũ cốc, dẫn xuất từ thực vật, khoáng chất, các loại đường.</li><li>Phụ gia dinh dưỡng: Vitamin D3, E1 (Sắt), E2 (I ốt), E4 (Đồng), E5 (Mangan), E6 (Kẽm).</li></ul><p><strong>Hướng dẫn sử dụng</strong></p><ul><li>Dựa theo độ tuổi và cân nặng của mèo, cho ăn một lượng vừa đủ vào các giờ cố định.</li><li>Có thể trộn với các thức ăn khác hoặc cho ăn trực tiếp.</li><li>Bảo quản: bảo quản ở nơi cao ráo, thoáng mát, tránh ánh nắng mặt trời. Khi mèo dùng không hết, các bạn bọc kín pate và bảo quản tủ lạnh tối đa 3 ngày và nhớ để ở nhiệt độ phòng cho pate bớt lạnh trước khi cho mèo dùng tiếp.</li></ul><p>Lưu ý:<br>&nbsp;</p><ul><li>Không cho mèo ăn quá nhiều trong một lần.</li><li>Nên cho mèo ăn thức ăn chế biến riêng, không cho ăn thức ăn thừa của người. Vì thức ăn của người có nhiều thành phần khiến mèo bị rối loạn tiêu hóa, ảnh hưởng đến sức khỏe của mèo.</li></ul>', '16-06-24');
...
--
ALTER TABLE `product`
  MODIFY `idPro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
COMMIT;

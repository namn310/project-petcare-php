...
<div class="pagetitle">
    ...
    <!-- End Page Title -->
    <form id="AddForm" class="row mt-4" method="post" action="index.php?controller=nhanvien&action=changePost&id=<?php echo $record->idNV ?>" enctype="multipart/form-data" style="background-color: white;padding:20px;border-radius:20px;box-shadow: 2px 2px 2px #FFCC99;">

        <div class="form-group col-md-4">
            <label style="font-weight: bolder;" class="control-label">Họ và tên</label>
            <input class="form-control" id="nameNV" name="nameNV" value="<?php echo $record->tenNV ?>" onclick="checkName()" onchange="checkName()" type="text">
        </div>
        <div class="form-group col-md-4">
            <label style="font-weight: bolder;" class="control-label">Địa chỉ email</label>
            <input class="form-control" id="emailNV" name="emailNV" value="<?php echo $record->email ?>" onclick="checkEmail()" onchange="checkEmail()" type="text">
        </div>
        <div class="form-group col-md-4">
            <label style="font-weight: bolder;" class="control-label mt-3">Địa chỉ thường trú</label>
            <input class="form-control" id="localNV" name="localNV" value="<?php echo $record->diachi ?>" onclick="checkLocalNV()" onchange="checkLocalNV()" type="text">
        </div>
        <div class="form-group  col-md-4">
            <label style="font-weight: bolder;" class="control-label mt-3">Số điện thoại</label>
            <input class="form-control" id="phoneNV" name="phoneNV" value="<?php echo $record->phone ?>" onclick="checkPhone()" onchange="checkPhone()" type="text">
        </div>

        <div class="form-group  col-md-3">
            <label style="font-weight: bolder;" style="font-weight: bolder;" class="control-label mt-3">Ngày tháng năm sinh</label>
            <input class="form-control" id="dateNV" name="dateNV" value="<?php echo $record->birth ?>" onclick="checkDateNV()" onchange="checkDateNV()" type="date">
        </div>
        <div class="form-group col-md-3">
            <label style="font-weight: bolder;" class="control-label mt-3">Số CMND/CCCD</label>
            <input class="form-control" onclick="checkCMND()" value="<?php echo $record->tenNV ?>" onchange="checkCMND()" name="CMND" id="CMND" type="text">
        </div>
        ...
        <div class="form-group col-md-3">
            ...
            <select class="form-control" name="sex" id="sex" onclick="checkSex()" onchange="checkSex()" id="exampleSelect2">
                <option><?php echo $record->sex ?></option>
                <option>Nam</option>
                <option>Nữ</option>
                <option>Khác</option>
            </select>
        ...
        <div class="form-group  col-md-3">
            ...
            <select class="form-control" onclick="checkChucVuNV()" onchange="checkChucVuNV()" name="chucvuNV" id="chucvuNV">
                <option><?php echo $record->chucvu ?></option>
        ...
        <img style="width:200px;height:200px;margin-top:20px" src="../assets/img-nhanvien/<?php echo $record->anhNV ?>">

...
<div class="pagetitle">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb" style="font-size: 22px;">
            <li class="breadcrumb-item"><a href="index.php?controller=danhmuc">Quản lý dịch vụ</a></li>
            <li class="breadcrumb-item active" aria-current="page">Thêm dịch vụ</li>
        </ol>
    </nav>

    <!-- End Page Title -->
    <form id="AddForm" method="post" class="AddForm row mt-4" action="index.php?controller=dichvu&action=createPost" enctype="multipart/form-data" style="background-color: white;padding:20px;border-radius:20px;box-shadow: 2px 2px 2px #FFCC99;">

        <div class="form-group ">
            <label style="font-weight: bolder;" class="control-label">Tên dịch vụ</label>
            <input class="form-control" id="nameDM" name="nameDM" onclick="checkName()" style="max-width:50%" onchange="checkName()" type="text">
        </div>

        <br>
        <div class="form-group mt-3">
            <label style="font-weight: bolder;" class="control-label">Ảnh dịch vụ</label>
            <input class="form-control" id="nameDM" name="hinhanh" onclick="checkName()" style="max-width:30%" onchange="checkName()" type="file">
        </div>
